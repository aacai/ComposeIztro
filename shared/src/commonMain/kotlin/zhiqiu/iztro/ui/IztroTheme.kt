...
data class IztroColors(
    ...
    val selfKe: Color,
    val selfJi: Color,
    /** 运限动态宫名：运紫 / 年黄 / 月绿 / 日棕 / 时蓝 */
    val scopePalaceDecadal: Color,
    val scopePalaceYearly: Color,
    val scopePalaceMonthly: Color,
    val scopePalaceDaily: Color,
    val scopePalaceHourly: Color,
    /** 未激活运限按钮底 */
    ...
    companion object {
        val Light = IztroColors(
            ...
            scopePalaceDecadal = Color(0xFF7B1FA2),
            scopePalaceYearly = Color(0xFFF9A825),
            scopePalaceMonthly = Color(0xFF2E7D32),
            scopePalaceDaily = Color(0xFF8D6E63),
            scopePalaceHourly = Color(0xFF1565C0),
        ...
        val Dark = IztroColors(
            ...
            selfQuan = Color(0xFFA1887F),
            selfKe = Color(0xFF64B5F6),
            selfJi = Color(0xFFEF5350),
            scopePalaceDecadal = Color(0xFFCE93D8),
            scopePalaceYearly = Color(0xFFFFD54F),
            scopePalaceMonthly = Color(0xFF81C784),
            scopePalaceDaily = Color(0xFFBCAAA4),
            scopePalaceHourly = Color(0xFF64B5F6),
